...
num1 = float(input("Indique o número total de eleitores do município:"))
num2 = float(input("Indique o número total de votos brancos:"))
num3 = float(input("Indique o número de votos nulos:"))
num4 = float(input("Indique o número de votos válidos:"))
